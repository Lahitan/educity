  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <h2>Nurturing Tomorrow's Leaders Todat</h2>
        <p>
        ...
        <p>
          Whether you aspire to become a teacher, administrator,counselor, or educational leader, our diverse range of programs offers the perfect 
          pathways to achieve your goals and unlock your full potentials in shapping the future of education.
        </p>
      </div>
    </div>
  )
